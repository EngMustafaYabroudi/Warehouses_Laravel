                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('read_storehouses_management'))
                            <a href="{{ route('admin.Storehouse_mangament.products.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif

                        @if (auth()->user()->hasPermission('delete_storehouses_management'))
...
@push('scripts')
    ...
    <script>
        ...
        let productsTable = $('#products-table').DataTable({
            ...
            ajax: {
                url: '{{ route('admin.Storehouse_mangament.products.data') }}',
                data: function (d) {
