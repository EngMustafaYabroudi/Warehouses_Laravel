...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('category.categories')</li>
    </ul>
    <div class="row">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('read_category'))
                            <a href="{{ route('admin.category.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="categories-table" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <th>@lang('category.created_by')</th>
